...
class TestCommandCreateConfig(TestCase):
    ...
    def test_get_create_mode(self, os_makedirs):
        with patch("builtins.open", mock_open()) as mock_file:
            ...
            mock_file.assert_called_with(os.path.normpath("/home/test/modes/testmode/config/testmode.yaml"), "w", encoding="utf-8")
    ...
    def test_get_create_machine_config(self, os_makedirs):
        with patch("builtins.open", mock_open()) as mock_file:
            ...
            mock_file.assert_any_call(os.path.normpath("/home/testmachine/config/config.yaml"), "w", encoding="utf-8")

            mock_file.assert_any_call(os.path.normpath("/home/testmachine/tests/test_testmachine.yaml"), "w", encoding="utf-8")
    ...
    def test_get_create_shows(self, os_makedirs):
        with patch("builtins.open", mock_open()) as mock_file:
            ...
            mock_file.assert_called_with(os.path.normpath("/home/test/shows/testshow.yaml"), "w", encoding="utf-8")
