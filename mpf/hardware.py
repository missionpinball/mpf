...
class Platform(object):
    ...
    def timer_config(self, HZ):
        if HZ:
            mpf.timing.HZ = HZ
            mpf.timing.secs_per_tick = 1 / float(HZ)
...
class HardwareDriver(HardwareObject):
    """ This is the generic class that hold driver elements. This exposes the
    methods you can use. Then each platform module subclasses these to actually
    perform the actions.
    """
