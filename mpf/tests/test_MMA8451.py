...
class TestMMA8451(MpfTestCase):
    ...
    def setUp(self):
        ...
        with patch("mpf.platforms.virtual.VirtualHardwarePlatform.i2c_read8", new=self.i2c_read8):
            with patch("mpf.platforms.virtual.VirtualHardwarePlatform.i2c_read_block", new=self.i2c_read_block):
                with patch("mpf.platforms.virtual.VirtualHardwarePlatform.i2c_write8", new=self.i2c_write8):
                    super().setUp()
