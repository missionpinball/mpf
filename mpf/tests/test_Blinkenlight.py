...
class TestBlinkenlight(MpfGameTestCase):
    ...
    def test_remove_all_colors_from_all_blinkenlights(self):
        ...
        self.assertPlaceholderEvaluates(3, 'device.blinkenlights.my_blinkenlight2.num_colors')
        self.assertPlaceholderEvaluates(3, 'device.blinkenlights.my_blinkenlight3.num_colors')
