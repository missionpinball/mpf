...
class TestGame(MpfGameTestCase):
    ...
    def testSinglePlayerGame(self):
        ...
        self.assertEqual('player_turn_will_start', self._events.call_args_list[5][1]['event_name'])
        self.assertEqual('player_turn_starting', self._events.call_args_list[6][1]['event_name'])
        self.assertEqual('player_turn_started', self._events.call_args_list[7][1]['event_name'])
        self.assertEqual(1, self._events.call_args_list[7][1]['number'])
        self.assertEqual('ball_will_start', self._events.call_args_list[8][1]['event_name'])
        self.assertEqual('ball_starting', self._events.call_args_list[9][1]['event_name'])
        self.assertEqual(2, self._events.call_args_list[9][1]['balls_remaining'])
        self.assertFalse(self._events.call_args_list[9][1]['is_extra_ball'])
        self.assertEqual('ball_started', self._events.call_args_list[10][1]['event_name'])
        self.assertEqual(1, self._events.call_args_list[10][1]['ball'])
        self.assertEqual(1, self._events.call_args_list[10][1]['player'])
        self.assertEqual('game_started', self._events.call_args_list[11][1]['event_name'])
    ...
    def testMultiplePlayerGame(self):
        ...
        self.assertEqual('player_added', self._events.call_args_list[1][1]['event_name'])
