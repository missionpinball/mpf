...
Also note that these files are for a Williams Judge Dredd machine controlled by
a P-ROC, so DO NOT RUN THEM ON A REAL MACHINE until you verify the hardware,
switch, and coil numbers are correct for your machine. Since every machine is
different, if you ran this on some other machine you might end up damaging your
hardware.
