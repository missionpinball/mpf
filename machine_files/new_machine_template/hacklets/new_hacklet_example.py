"""Example hacklet which shows different things you can do."""

from mpf.system.hacklet import Hacklet  # This import is required


class YourHackletName(Hacklet):  # Change `YourHackletName` to whatever you want!
    """To 'activate' your hacklet:
        ...
        3. That entry should be 'your_hacklet_file_name.YourHackletName'
    """

    def on_load(self):
        """Called automatically when this hacklet is loaded."""

        # add code here to do whatever you want your hacklet to do when the
        # machine boots up.

        # This example hacklet has lots of different examples which show (some)
        # of the things you can do. Feel free to delete everything from here on
        # down when you create your own hacklet.
        ...
        # you can access this hacklet's name (based on the class name above):
        print self.name  # will print `YourHackletName` in this case

        # you can write to the log via self.log:
        # The logger will be prefaced with Hacklet.YourHackletName
        self.log.info("This is my hacklet")
        ...
        # like: self.machine.config['YourHacklet']['Your Setting']
    ...
    def my_handler(self):
        ...
        # many methods as you want in your hacklet!
