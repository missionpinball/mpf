...
class TestConfig(MpfTestCase):
    ...
    def test_config_file(self):
        ...
        self.assertEquals('003200', self.machine.config['test_section']['str_003200'])
        self.assertEquals('001', self.machine.config['test_section']['str_001'])
        self.assertEquals(100, self.machine.config['test_section']['int_100'])
