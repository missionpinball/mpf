...
class TestDeviceMatrixLight(MpfTestCase):
    ...
    def testBasicOnAndOff(self):
        ...
        self.assertEqual(Clock.get_time(), self.machine.lights.light_01.cache['start_time'])
        ...
        self.assertEqual(Clock.get_time(), self.machine.lights.light_02.cache['start_time'])
    ...
    def testOneSecondFadeUp(self):
        ...
        fade_start_time = Clock.get_time()
        self.assertEqual(0, self.machine.lights.light_01.state['brightness'])
        ...
        self.assertEqual(Clock.get_time(), self.machine.lights.light_01.state['start_time'])
        self.assertEqual(Clock.get_time() + 1, self.machine.lights.light_01.state['destination_time'])
        self.assertEqual(0, self.machine.lights.light_01.hw_driver.current_brightness)
        self.assertEqual(0, self.machine.lights.light_01.state['priority'])
